...
export const categoriesRepository: CategoryRepository = {
  createTable: async () => {
    await execMySqlQuery(`CREATE TABLE IF NOT EXISTS categories (
  ...
  create: async (payload) => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return categoriesRepository.findById ? (categoriesRepository.findById(payload.id) as any) : undefined;
  },
  findById: async (id) => {
